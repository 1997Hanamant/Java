...
public enum PartyNameProperties {
	AITC("All India Trinamool Congress"), BSP("Bahujan Samaj Party "), BJP("Bharatiya Janata Party "),
	CPI("Communist Party of India"), INC("Indian National Congress "), NCP("Nationalist Congress Party"),
	NPP("National People's Party"), PK("Prajakeeya"), JDS("Janatadal Secular"), AAP("Aam Aadmi Party"), DEFAULT("NA");
